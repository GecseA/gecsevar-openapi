...
class MyTest {
    ...
    fun test1() {
        ...
        val configurator = CodegenConfigurator()
            .setGeneratorName("kotlin-server")
            .setInputSpec("app/src/main/resources/test_1.yml")
            .setOutputDir("generated/")
            .setApiPackage("hu.gecsevar.openapi.app.plugins.api")
            .setModelPackage("hu.gecsevar.openapi.app.database.view")
